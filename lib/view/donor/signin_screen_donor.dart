...
class SignUpScreenDonor extends StatefulWidget {
  const SignUpScreenDonor({super.key});

  @override
  State<SignUpScreenDonor> createState() => _SignUpScreenDonorState();
}

class _SignUpScreenDonorState extends State<SignUpScreenDonor> {
  ...
  void _signUpWithEmail() async {
    ...
    try {
      ...
      print("User from signin screen donor inside create account method $newUser");
      Get.offNamed(
        AppRoutes.createProfileDonor,
        arguments: newUser,
      );
    } catch (e) {
      setState(() => _isLoading = false);
